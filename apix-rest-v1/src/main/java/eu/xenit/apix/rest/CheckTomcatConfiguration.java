...
//            logger.error("JNDI ctx.lookup(\"java:comp/env/env/myConfig\"): ", value);
            ...
            if (reader == null) {
                logger.error(
                        "No Tomcat context.xml is found under Path: \"/usr/local/tomcat/webapps/alfresco/META-INF/context.xml\".\n "
    ...
    protected void printWarning() {
        logger.error(
                "There is a chance your Tomcat /META-INF/context.xml file is auto-generated and does not contain the necessary configuration.\n"
