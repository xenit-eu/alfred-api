...
REM rmdir /s /q "apix-integrationtests/60/src/integration-test/java-shared"
...
REM mkdir "apix-integrationtests/60/src/integration-test"
...
REM mklink /J "apix-integrationtests/60/src/integration-test/java-shared" "apix-impl/src/integration-test/java"
