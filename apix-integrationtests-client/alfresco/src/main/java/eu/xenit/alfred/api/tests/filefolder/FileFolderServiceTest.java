...
public class FileFolderServiceTest extends JavaApiBaseTest {
    ...
    public void testCreateFolder() {
        ...
        try {
            eu.xenit.alfred.api.data.NodeRef parentNodeRef = c.apix(testFolder.getNodeRef());
    ...
    public void testCreateDeepFolder() {
        ...
        try {
            eu.xenit.alfred.api.data.NodeRef parentNodeRef = c.apix(testFolder.getNodeRef());
            eu.xenit.alfred.api.data.NodeRef parentSubFolderNodeRef = c.apix(testSubFolder.getNodeRef());
    ...
    public void testGetCompanyHome() {
        ...
        eu.xenit.alfred.api.data.NodeRef apixRef = service.getCompanyHome();
        eu.xenit.alfred.api.data.NodeRef check = c.apix(alfRef);
