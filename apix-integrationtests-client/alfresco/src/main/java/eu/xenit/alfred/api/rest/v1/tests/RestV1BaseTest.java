...
public abstract class RestV1BaseTest extends BaseApplicationContextTest {
    ...
    protected HashMap<String, eu.xenit.alfred.api.data.NodeRef> init(final String testName) {
        ...
        RetryingTransactionHelper.RetryingTransactionCallback<Object> txnWork = () -> {
            ...
            eu.xenit.alfred.api.data.NodeRef apixTestNodeRef = new eu.xenit.alfred.api.data.NodeRef(testNodeRef.toString());
            ...
            eu.xenit.alfred.api.data.NodeRef apixTestNodeRef2 = new eu.xenit.alfred.api.data.NodeRef(testNodeRef2.toString());
            ...
            eu.xenit.alfred.api.data.NodeRef apixTestNodeRef3 = new eu.xenit.alfred.api.data.NodeRef(testNodeRef3.toString());
            ...
            eu.xenit.alfred.api.data.NodeRef apixNoUserRightsNodeRef = new eu.xenit.alfred.api.data.NodeRef(
