...
public class WorkflowService_UpdateMixedProperties_TestJavaApi extends WorkflowService_JavaApi_BaseMethod_Test {

    protected final static Logger logger = LoggerFactory.getLogger(WorkflowService_UpdateMixedProperties_TestJavaApi.class);
    ...
    public void testUpdateMixedProperties() {
        ...
        for (String taskID : taskIDs) {
            ...
            assertTrue(apixProbeUpdateProperties(taskID, mixedPropertiesPayload, unmodifiableProperties));
        }
    }
}
