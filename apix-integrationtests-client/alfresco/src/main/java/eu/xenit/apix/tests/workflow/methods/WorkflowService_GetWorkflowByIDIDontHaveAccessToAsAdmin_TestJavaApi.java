...
public class WorkflowService_GetWorkflowByIDIDontHaveAccessToAsAdmin_TestJavaApi extends
        WorkflowService_JavaApi_BaseMethod_Test {

    protected final static Logger logger = LoggerFactory
            .getLogger(WorkflowService_GetWorkflowByIDIDontHaveAccessToAsAdmin_TestJavaApi.class);
