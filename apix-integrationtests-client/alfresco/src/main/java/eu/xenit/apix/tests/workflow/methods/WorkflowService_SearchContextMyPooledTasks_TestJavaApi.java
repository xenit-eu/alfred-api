...
public class WorkflowService_SearchContextMyPooledTasks_TestJavaApi extends WorkflowService_JavaApi_BaseMethod_Test {

    protected final static Logger logger = LoggerFactory
            .getLogger(WorkflowService_SearchContextMyPooledTasks_TestJavaApi.class);
