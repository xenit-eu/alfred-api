...
public class WorkflowService_ReleaseOnOtherClaimedTasksAsAdmin_TestJavaApi extends
        WorkflowService_JavaApi_BaseMethod_Test {

    protected final static Logger logger = LoggerFactory
            .getLogger(WorkflowService_ReleaseOnOtherClaimedTasksAsAdmin_TestJavaApi.class);
