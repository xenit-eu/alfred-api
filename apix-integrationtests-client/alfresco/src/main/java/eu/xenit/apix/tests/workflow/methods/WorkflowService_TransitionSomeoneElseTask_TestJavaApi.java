...
public class WorkflowService_TransitionSomeoneElseTask_TestJavaApi extends WorkflowService_JavaApi_BaseMethod_Test {

    protected final static Logger logger = LoggerFactory
            .getLogger(WorkflowService_TransitionSomeoneElseTask_TestJavaApi.class);
            ...
            for (String transition : targetTasksMap.keySet()) {
                ...
                for (String taskIdToTransition : taskIdToTransitions) {
                    logger.debug("Claimed task: '" + taskIdToTransition + "' " + apixProbeClaimTask(taskIdToTransition,
                            USER_A));
                    apixWorkflowService.endTask(taskId, transition);
                }
            }
        }
    }
