...
public class WorkflowService_UpdateNull_TestJavaApi extends WorkflowService_JavaApi_BaseMethod_Test {

    protected final static Logger logger = LoggerFactory.getLogger(WorkflowService_UpdateNull_TestJavaApi.class);
    ...
    public void testUpdateNull() {
        ...
        for (String taskID : taskIDs) {
            ...
            Task updatedTask = this.apixWorkflowService.updateTask(taskID, null);
