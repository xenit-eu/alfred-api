...
public class WorkflowService_GetTaskByIDIDontHaveAccessTo_TestJavaApi extends WorkflowService_JavaApi_BaseMethod_Test {

    protected final static Logger logger = LoggerFactory
            .getLogger(WorkflowService_GetTaskByIDIDontHaveAccessTo_TestJavaApi.class);
        ...
        Object result = this.transactionHelper
                .doInTransaction(new RetryingTransactionHelper.RetryingTransactionCallback<Object>() {
                    ...
                    public Object execute() {
                        tasksToMap.put("testGetTaskByIDIDontHaveAccessTo", new ArrayList() {{
    ...
    public void testGetTaskByIDIDontHaveAccessTo() {
        ...
        for (String taskID : taskIDs) {
            ...
            assertFalse(hasAccessToWorkflowTask(taskID));
        }
    }
}
