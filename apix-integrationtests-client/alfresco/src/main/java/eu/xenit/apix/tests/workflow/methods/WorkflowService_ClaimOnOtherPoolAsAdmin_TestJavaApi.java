...
public class WorkflowService_ClaimOnOtherPoolAsAdmin_TestJavaApi extends WorkflowService_JavaApi_BaseMethod_Test {

    protected final static Logger logger = LoggerFactory.getLogger(WorkflowService_ClaimOnOtherPoolAsAdmin_TestJavaApi.class);
