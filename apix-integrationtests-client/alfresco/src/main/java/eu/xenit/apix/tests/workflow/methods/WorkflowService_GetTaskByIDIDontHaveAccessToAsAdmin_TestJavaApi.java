...
public class WorkflowService_GetTaskByIDIDontHaveAccessToAsAdmin_TestJavaApi extends
        WorkflowService_JavaApi_BaseMethod_Test {

    protected final static Logger logger = LoggerFactory
            .getLogger(WorkflowService_GetTaskByIDIDontHaveAccessToAsAdmin_TestJavaApi.class);
