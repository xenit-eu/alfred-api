...
public class WorkflowService_CancelSomebodyElseWorkflow_TestJavaApi extends WorkflowService_JavaApi_BaseMethod_Test {

    protected final static Logger logger = LoggerFactory
            .getLogger(WorkflowService_CancelSomebodyElseWorkflow_TestJavaApi.class);
