 ...
 */
@Component("eu.xenit.apix.webscripts.arguments.HandlerMethodArgumentsResolver")
@OsgiService
public class HandlerMethodArgumentsResolver {

    /* Dependencies */

    //TODO: this might not be needed if osgi is not here
...
//        }
        ...
        for (int index = 0; index < parameterTypes.length; index++) {
            ...
            if (argumentResolver == null) {
                throw new IllegalStateException(
                        String.format("Cannot map parameter at index %d of method %s.%s.", index,
    ...
    protected ArgumentResolver<Object, Annotation> getArgumentResolver(final Class<?> parameterType,
        ...
        for (ArgumentResolver argumentResolver : springArgumentResolvers) {
