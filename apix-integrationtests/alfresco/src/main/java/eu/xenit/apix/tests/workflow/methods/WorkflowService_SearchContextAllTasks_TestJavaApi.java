...
public class WorkflowService_SearchContextAllTasks_TestJavaApi extends WorkflowService_JavaApi_BaseMethod_Test {

    protected final static Logger logger = LoggerFactory.getLogger(WorkflowService_SearchContextAllTasks_TestJavaApi.class);
