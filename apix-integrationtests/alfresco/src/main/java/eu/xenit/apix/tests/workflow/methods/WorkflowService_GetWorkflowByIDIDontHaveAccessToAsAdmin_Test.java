...
public class WorkflowService_GetWorkflowByIDIDontHaveAccessToAsAdmin_Test extends WorkflowService_BaseMethod_Test {

    protected final static Logger logger = LoggerFactory
            .getLogger(WorkflowService_GetWorkflowByIDIDontHaveAccessToAsAdmin_Test.class);
        ...
        Object result = this.transactionHelper
                .doInTransaction(new RetryingTransactionHelper.RetryingTransactionCallback<Object>() {
                    ...
                    public Object execute() {
                        wfPaths.put("testGetWorkflowByIDIDontHaveAccessToAsAdmin",
    ...
    @Test
    public void testGetWorkflowByIDIDontHaveAccessToAsAdmin() {
