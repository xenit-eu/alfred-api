...
public class WorkflowService_GetWorkflowByIDIDontHaveAccessTo_TestJavaApi extends
        WorkflowService_JavaApi_BaseMethod_Test {

    protected final static Logger logger = LoggerFactory
            .getLogger(WorkflowService_GetWorkflowByIDIDontHaveAccessTo_TestJavaApi.class);
