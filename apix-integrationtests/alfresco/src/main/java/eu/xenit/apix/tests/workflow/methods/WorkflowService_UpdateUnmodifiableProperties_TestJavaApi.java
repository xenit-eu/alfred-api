...
public class WorkflowService_UpdateUnmodifiableProperties_TestJavaApi extends WorkflowService_JavaApi_BaseMethod_Test {

    protected final static Logger logger = LoggerFactory
            .getLogger(WorkflowService_UpdateUnmodifiableProperties_TestJavaApi.class);
