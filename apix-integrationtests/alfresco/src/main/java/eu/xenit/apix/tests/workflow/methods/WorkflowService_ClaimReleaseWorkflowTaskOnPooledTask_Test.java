...
public class WorkflowService_ClaimReleaseWorkflowTaskOnPooledTask_Test extends WorkflowService_BaseMethod_Test {

    protected final static Logger logger = LoggerFactory
            .getLogger(WorkflowService_ClaimReleaseWorkflowTaskOnPooledTask_Test.class);
