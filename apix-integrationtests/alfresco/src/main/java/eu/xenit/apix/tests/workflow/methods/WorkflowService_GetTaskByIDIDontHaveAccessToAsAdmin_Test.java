...
public class WorkflowService_GetTaskByIDIDontHaveAccessToAsAdmin_Test extends WorkflowService_BaseMethod_Test {

    protected final static Logger logger = LoggerFactory
            .getLogger(WorkflowService_GetTaskByIDIDontHaveAccessToAsAdmin_Test.class);
        ...
        Object result = this.transactionHelper
                .doInTransaction(new RetryingTransactionHelper.RetryingTransactionCallback<Object>() {
                    ...
                    public Object execute() {
                        tasksToMap.put("testGetTaskByIDIDontHaveAccessToAsAdmin", new ArrayList() {{
    ...
    @Test
    public void testGetTaskByIDIDontHaveAccessToAsAdmin() {
