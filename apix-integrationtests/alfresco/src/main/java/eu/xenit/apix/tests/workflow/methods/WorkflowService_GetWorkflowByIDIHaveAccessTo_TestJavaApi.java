...
public class WorkflowService_GetWorkflowByIDIHaveAccessTo_TestJavaApi extends WorkflowService_JavaApi_BaseMethod_Test {

    protected final static Logger logger = LoggerFactory
            .getLogger(WorkflowService_GetWorkflowByIDIHaveAccessTo_TestJavaApi.class);
