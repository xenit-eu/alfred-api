...
public class WorkflowService_UpdateEmpty_TestJavaApi extends WorkflowService_JavaApi_BaseMethod_Test {

    protected final static Logger logger = LoggerFactory.getLogger(WorkflowService_UpdateEmpty_TestJavaApi.class);
