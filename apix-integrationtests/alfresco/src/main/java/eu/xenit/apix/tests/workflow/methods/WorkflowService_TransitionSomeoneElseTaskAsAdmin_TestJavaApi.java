...
public class WorkflowService_TransitionSomeoneElseTaskAsAdmin_TestJavaApi extends
        WorkflowService_JavaApi_BaseMethod_Test {

    protected final static Logger logger = LoggerFactory
            .getLogger(WorkflowService_TransitionSomeoneElseTaskAsAdmin_TestJavaApi.class);
