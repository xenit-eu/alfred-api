...
public class WorkflowService_UpdateModifiableProperties_TestJavaApi extends WorkflowService_JavaApi_BaseMethod_Test {

    protected final static Logger logger = LoggerFactory
            .getLogger(WorkflowService_UpdateModifiableProperties_TestJavaApi.class);
    ...
    public void testUpdateModifiableProperties() {
        ...
        for (String taskID : taskIDs) {
            ...
            assertTrue(apixProbeUpdateProperties(taskID, modifiablePropertiesPayload));
        }
    }
}
