...
public class WorkflowService_ClaimOnOtherPool_Test extends WorkflowService_BaseMethod_Test {

    protected final static Logger logger = LoggerFactory.getLogger(WorkflowService_ClaimOnOtherPool_Test.class);
    ...
    public void testClaimOnOtherPool() {
        ...
        for (String taskID : taskIDs) {
            ...
            this.alfredApiWorkflowService.claimWorkflowTask(taskID, USER_FOREIGNER);
        }
    }
}
