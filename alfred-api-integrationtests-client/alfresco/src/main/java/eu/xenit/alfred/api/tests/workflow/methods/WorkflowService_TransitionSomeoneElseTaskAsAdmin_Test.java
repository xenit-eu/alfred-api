...
public class WorkflowService_TransitionSomeoneElseTaskAsAdmin_Test extends
        WorkflowService_BaseMethod_Test {

    protected final static Logger logger = LoggerFactory
            .getLogger(WorkflowService_TransitionSomeoneElseTaskAsAdmin_Test.class);
        ...
        Object result = this.transactionHelper
                .doInTransaction(new RetryingTransactionHelper.RetryingTransactionCallback<Object>() {
                    ...
                    public Object execute() {
                        tasksToMap.put("testTransitioningSomeoneElseTasksAsAdmin", new ArrayList() {{
    ...
    @Test
    public void testTransitioningSomeoneElseTasksAsAdmin() {
            ...
            for (String transition : targetTasksMap.keySet()) {
                ...
                for (String taskIdToTransition : taskIdToTransitions) {
                    logger.debug("Claimed task: '" + taskIdToTransition + "' " + alfredApiProbeClaimTask(taskIdToTransition,
                            USER_A));
                    probeAlfredApiTransitionTask(transition, taskIdToTransition);
                }
            }
        }
    }
