...
public class WorkflowService_TransitionMyTask_Test extends WorkflowService_BaseMethod_Test {

    protected final static Logger logger = LoggerFactory.getLogger(WorkflowService_TransitionMyTask_Test.class);
