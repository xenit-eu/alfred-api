...
public abstract class RestV1BaseTest extends BaseApplicationContextTest {
    ...
    protected String createAlfredApiUrl(String subUrl, Object... args) {
    ...
    protected String makeFormsUrl(eu.xenit.alfred.api.data.NodeRef nodeRef, String action, String userName, String passWord) {
    ...
    protected String makeFormsUrl(eu.xenit.alfred.api.data.NodeRef nodeRef, String userName, String passWord) {
        return this.makeFormsUrl(nodeRef, "", userName, passWord);
    }

    protected String makeFormsUrl(eu.xenit.alfred.api.data.NodeRef nodeRef) {
    ...
    protected String makeWorkingCopiesUrl(eu.xenit.alfred.api.data.NodeRef nodeRef, String action, String userName,
            String passWord) {
        String space = nodeRef.getStoreRefProtocol();
        String store = nodeRef.getStoreRefId();
        String guid = nodeRef.getGuid();
    ...
    protected String makeCommentsUrl(eu.xenit.alfred.api.data.NodeRef nodeRef, String userName, String password) {
        String space = nodeRef.getStoreRefProtocol();
        String store = nodeRef.getStoreRefId();
        String guid = nodeRef.getGuid();
    ...
    protected HashMap<String, eu.xenit.alfred.api.data.NodeRef> init() {
        return init(null);
    }

    protected HashMap<String, eu.xenit.alfred.api.data.NodeRef> init(final String testName) {
        final HashMap<String, eu.xenit.alfred.api.data.NodeRef> initializedNodeRefs = new HashMap<>();
        ...
        RetryingTransactionHelper.RetryingTransactionCallback<Object> txnWork = () -> {
            ...
            initializedNodeRefs.put(TESTFOLDER_NAME,
                    new eu.xenit.alfred.api.data.NodeRef(testFolder.getNodeRef().toString()));
            ...
            eu.xenit.alfred.api.data.NodeRef alfredApiTestNodeRef = new eu.xenit.alfred.api.data.NodeRef(testNodeRef.toString());
            initializedNodeRefs.put(TESTFILE_NAME, alfredApiTestNodeRef);
            ...
            eu.xenit.alfred.api.data.NodeRef alfredApiTestNodeRef2 = new eu.xenit.alfred.api.data.NodeRef(testNodeRef2.toString());
            initializedNodeRefs.put(TESTFILE2_NAME, alfredApiTestNodeRef2);

            FileInfo testNode3 = createTestNode(testFolder2.getNodeRef(), TESTFILE3_NAME,
                    ContentModel.TYPE_CONTENT);
            NodeRef testNodeRef3 = testNode3.getNodeRef();
            eu.xenit.alfred.api.data.NodeRef alfredApiTestNodeRef3 = new eu.xenit.alfred.api.data.NodeRef(testNodeRef3.toString());
            initializedNodeRefs.put(TESTFILE3_NAME, alfredApiTestNodeRef3);
            ...
            eu.xenit.alfred.api.data.NodeRef alfredApiNoUserRightsNodeRef = new eu.xenit.alfred.api.data.NodeRef(
                    noUserRightsNodeRef.toString());
            initializedNodeRefs.put(NOUSERRIGHTS_FILE_NAME, alfredApiNoUserRightsNodeRef);
    ...
    protected String makeNodesUrl(eu.xenit.alfred.api.data.NodeRef nodeRef, String userName, String passWord) {
        return this.makeNodesUrl(nodeRef, "", userName, passWord);
    }

    protected String makeNodesUrlWithTicket(eu.xenit.alfred.api.data.NodeRef nodeRef) {
        return this.makeNodesUrlWithTicket(nodeRef, "");
    }

    protected String makeNodesUrl(eu.xenit.alfred.api.data.NodeRef nodeRef, String action, String userName, String passWord) {
        String space = nodeRef.getStoreRefProtocol();
        String store = nodeRef.getStoreRefId();
        String guid = nodeRef.getGuid();
    ...
    protected String makeNodesUrlWithTicket(eu.xenit.alfred.api.data.NodeRef nodeRef, String action) {
        String space = nodeRef.getStoreRefProtocol();
        String store = nodeRef.getStoreRefId();
        String guid = nodeRef.getGuid();
