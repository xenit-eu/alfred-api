...
public class WorkflowService_GetTaskByIDIHaveAccessTo_Test extends WorkflowService_BaseMethod_Test {

    protected final static Logger logger = LoggerFactory.getLogger(WorkflowService_GetTaskByIDIHaveAccessTo_Test.class);
