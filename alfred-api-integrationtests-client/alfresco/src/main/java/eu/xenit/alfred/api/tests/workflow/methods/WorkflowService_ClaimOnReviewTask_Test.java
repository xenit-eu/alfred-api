...
public class WorkflowService_ClaimOnReviewTask_Test extends WorkflowService_BaseMethod_Test {

    protected final static Logger logger = LoggerFactory.getLogger(WorkflowService_ClaimOnReviewTask_Test.class);
