...
public class SearchFacetServiceUnitTest {
    ...
    public void initMocks() {
        ...
        QName languageQName = QName.createQName("{http://test.alfredapi.xenit.eu/model/content}language");
        ...
        theListOfValuesConstraint
                .setShortName("{http://test.alfredapi.xenit.eu/model/content}model_hasLanguage_language_anon_0");
        ...
        QName documentStatusQName = QName.createQName("{http://test.alfredapi.xenit.eu/model/content}documentStatus");
        ...
        docStatLOVConstr.setShortName(
                "{http://test.alfredapi.xenit.eu/model/content}model_withMandatoryPropDocument_documentStatus_anon_0");
        ...
        when(resultSetMock.getFieldFacet("@{http://test.alfredapi.xenit.eu/model/content}language"))
                .thenReturn(languageFieldFacetResults);
        when(resultSetMock.getFieldFacet("@{http://test.alfredapi.xenit.eu/model/content}documentStatus"))
        ...
        when(fieldFacetMock_A.getField()).thenReturn("@{http://test.alfredapi.xenit.eu/model/content}language");
        fieldFacets.add(fieldFacetMock_A);
        FieldFacet fieldFacetMock_B = mock(FieldFacet.class);
        when(fieldFacetMock_B.getField()).thenReturn("@{http://test.alfredapi.xenit.eu/model/content}documentStatus");
    ...
    public List<FacetSearchResult> initExpectedResult_for_assertThat_getFacetResults_returnIncludes_translationsForListOfValueConstraints() {
        ...
        languageResult.setName("{http://test.alfredapi.xenit.eu/model/content}language");
        ...
        documentStatusResult.setName("{http://test.alfredapi.xenit.eu/model/content}documentStatus");
