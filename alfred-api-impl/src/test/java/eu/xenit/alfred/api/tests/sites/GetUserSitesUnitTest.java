...
public class GetUserSitesUnitTest {
    ...
    public void testGetUserSites() {
        ...
        eu.xenit.alfred.api.alfresco.sites.SiteService alfredApiSiteService =
                new eu.xenit.alfred.api.alfresco.sites.SiteService(serviceRegistry, alfredApiAlfrescoConverter);

        String user = "testUser";
        List<ISite> testUserSites = alfredApiSiteService.getUserSites(user);
