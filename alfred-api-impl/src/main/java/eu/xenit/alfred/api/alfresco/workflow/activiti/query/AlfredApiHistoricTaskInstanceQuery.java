...
import eu.xenit.alfred.api.alfresco.workflow.utils.QueryStringFormatter;
...
public class AlfredApiHistoricTaskInstanceQuery extends AlfredApiHistoricInstanceQuery {

    private final Logger logger = LoggerFactory.getLogger(AlfredApiHistoricTaskInstanceQuery.class);
    private TaskQuery task;

    private IPeopleService peopleService;

    AlfredApiHistoricTaskInstanceQuery(ServiceRegistry serviceRegistry, IPeopleService peopleService) {
