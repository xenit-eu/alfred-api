package eu.xenit.alfred.api.alfresco.translation;
...
import eu.xenit.alfred.api.translation.PropertyTranslationValue;
import eu.xenit.alfred.api.translation.TranslationValue;
...
public class TranslationService implements ITranslationService {
    ...
    public long getTranslationsCheckSum(Locale locale) {
        try (ByteArrayOutputStream bytesOut = new ByteArrayOutputStream()) {
            ...
            Long modelChecksum = alfredApiDictionaryservice.getContentModelCheckSum();
...
//            Map<QName, Map<String, String>> constraints = new HashMap<>();
    ...
    private TranslationValue getTranslationValueObject(QName qname, Map<QName, TranslationValue> map) {
        ...
        if (!map.containsKey(qname)) {
            ...
            translationValue.setQname(alfredApiToAlfrescoConversion.alfredApi(qname));
