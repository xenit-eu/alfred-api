...
@Component("eu.xenit.alfred.api.alfresco.metadata.AlfrescoPropertyConvertor")
public class AlfrescoPropertyConvertor {
    ...
    public Map<eu.xenit.alfred.api.data.QName, List<String>> toModelPropertyValueList(
            Map<QName, Serializable> nodeProperties) {
        Map<eu.xenit.alfred.api.data.QName, List<String>> propertyValues = new HashMap<>();
        for (Map.Entry<org.alfresco.service.namespace.QName, Serializable> nodeProp : nodeProperties.entrySet()) {
            try {
                final Pair<eu.xenit.alfred.api.data.QName, List<String>> value = toModelPropertyValue(
    ...
    public Pair<eu.xenit.alfred.api.data.QName, List<String>> toModelPropertyValue(
        ...
        eu.xenit.alfred.api.data.QName propQName = c.alfredApi(alfQName);
        if (data == null) {
