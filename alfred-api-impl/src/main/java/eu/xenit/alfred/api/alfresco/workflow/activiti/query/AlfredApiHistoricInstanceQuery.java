...
public abstract class AlfredApiHistoricInstanceQuery {
    ...
    private final Logger logger = LoggerFactory.getLogger(AlfredApiHistoricInstanceQuery.class);
    ...
    public AlfredApiHistoricInstanceQuery(ServiceRegistry serviceRegistry) {
