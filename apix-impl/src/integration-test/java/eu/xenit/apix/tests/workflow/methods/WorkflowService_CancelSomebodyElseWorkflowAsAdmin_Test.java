...
public class WorkflowService_CancelSomebodyElseWorkflowAsAdmin_Test extends WorkflowService_BaseMethod_Test {
        ...
        Object result = this.transactionHelper
                .doInTransaction(new RetryingTransactionHelper.RetryingTransactionCallback<Object>() {
                    ...
                    public Object execute() {
                        wfPaths.put("testCancelSomebodyElseWorkflowAsAdmin",
    ...
    @Test
    public void testCancelSomebodyElseWorkflowAsAdmin() {
