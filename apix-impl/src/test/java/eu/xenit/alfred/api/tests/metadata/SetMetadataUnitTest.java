...
public class SetMetadataUnitTest {
    ...
    private eu.xenit.alfred.api.alfresco.metadata.NodeService nodeService;
    ...
    public void init() {
        ...
        nodeService = new eu.xenit.alfred.api.alfresco.metadata.NodeService(serviceRegistryMock, apixAlfrescoConverter);
    }
    ...
    public void testGeneralizeTypeWithCleanUpEnabled() {
        ...
        eu.xenit.alfred.api.data.NodeRef apixTestNodeRef = apixAlfrescoConverter.apixNodeRefs(testNodeRefSet).iterator()
                .next();
