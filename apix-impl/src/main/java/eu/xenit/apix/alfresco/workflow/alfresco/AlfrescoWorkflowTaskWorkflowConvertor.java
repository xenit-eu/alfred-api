...
public class AlfrescoWorkflowTaskWorkflowConvertor extends AbstractApixAlfrescoWorkflowConvertor {
    ...
    public <T> Task apply(T obj) {
        ...
        PutOnMapIfNotNull(props, WorkflowModel.ASSOC_ASSIGNEE, apixAssignee);
        ...
        PutOnMapIfNotNull(props, IWorkflowService.ALFRESCO_GROUP_ASSIGNEE, apixGroupAssignee);
