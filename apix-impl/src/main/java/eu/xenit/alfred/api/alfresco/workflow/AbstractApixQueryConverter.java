...
import eu.xenit.alfred.api.alfresco.workflow.activiti.query.ApixHistoricInstanceQuery;
...
public abstract class AbstractApixQueryConverter {
    ...
    public abstract ApixHistoricInstanceQuery convertQuery(SearchQuery var1);

    public abstract ITaskOrWorkflow get(String var1);

    public abstract void update(String var1, WorkflowOrTaskChanges var2);

    protected void ApplySearchQuery(SearchQuery searchQuery, ApixHistoricInstanceQuery q) {
