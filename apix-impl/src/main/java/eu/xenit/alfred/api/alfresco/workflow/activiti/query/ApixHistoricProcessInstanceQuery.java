...
public class ApixHistoricProcessInstanceQuery extends ApixHistoricInstanceQuery {
    ...
    private final Logger logger = LoggerFactory.getLogger(ApixHistoricProcessInstanceQuery.class);
    private HistoricProcessInstanceQuery process;

    ApixHistoricProcessInstanceQuery(ServiceRegistry serviceRegistry) {
