...
import eu.xenit.alfred.api.alfresco.workflow.AbstractApixAlfrescoWorkflowConvertor;
...
public class AlfrescoWorkflowTaskWorkflowConvertor extends AbstractApixAlfrescoWorkflowConvertor {
    ...
    public <T> Task apply(T obj) {
        ...
        eu.xenit.alfred.api.data.NodeRef apixAssignee = null;
        ...
        eu.xenit.alfred.api.data.NodeRef apixGroupAssignee = null;
