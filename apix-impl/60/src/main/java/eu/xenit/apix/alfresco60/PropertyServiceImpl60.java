...
@Primary
public class PropertyServiceImpl60 extends PropertyServiceBase {

    @Autowired
    public PropertyServiceImpl60(DictionaryService dictionaryService, ApixToAlfrescoConversion c) {
