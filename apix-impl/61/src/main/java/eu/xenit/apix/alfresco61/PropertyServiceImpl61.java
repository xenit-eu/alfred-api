...
@Primary
public class PropertyServiceImpl61 extends PropertyServiceBase {

    @Autowired
    public PropertyServiceImpl61(DictionaryService dictionaryService, ApixToAlfrescoConversion c) {
