...
public class SearchFacetServiceUnitTest42 {
    ...
    public void initMocks() {
        ...
        DataTypeDefinition dataTypeDefinitionMock = mock(DataTypeDefinition.class);
        when(dataTypeDefinitionMock.getName()).thenReturn(
              QName.createQName("{http://www.alfresco.org/model/dictionary/1.0}text"));
        when(languagePropDefMock.getDataType()).thenReturn(dataTypeDefinitionMock);
        ...
        theListOfValuesConstraint.setShortName("{http://test.apix.xenit.eu/model/content}model_hasLanguage_language_anon_0");
        ...
        when(documentStatusPropDefMock.getDataType()).thenReturn(dataTypeDefinitionMock);
        ...
        docStatLOVConstr.setShortName("{http://test.apix.xenit.eu/model/content}model_withMandatoryPropDocument_documentStatus_anon_0");
        ...
        FacetConfiguration facetConfigurationMock = mock(FacetConfiguration.class);
        searchFacetsService = new SearchFacetsServiceImpl42(serviceRegistryMock, facetConfigurationMock);
        ...
        when(resultSetMock.getFieldFacet("@{http://test.apix.xenit.eu/model/content}language")).thenReturn(languageFieldFacetResults);
        when(resultSetMock.getFieldFacet("@{http://test.apix.xenit.eu/model/content}documentStatus")).thenReturn(documentStatusFieldFacetResults);
