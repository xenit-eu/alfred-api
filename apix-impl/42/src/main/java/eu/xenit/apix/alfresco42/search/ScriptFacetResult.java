...
/*
 * This file is part of Alfresco 5.0
 *
 * This is distributed with APIX to provide a backwards compatabile model with Alfresco 4.x
 *
 * The 2 and only modifications are:
 * 1) the 'package namespace' to ensure there are
 * no namespace conflicts with future Alfresco 4.x service-packs
 * 2) this section of comments
 *
 * LGPL and Alfresco Copyright still apply
 */
