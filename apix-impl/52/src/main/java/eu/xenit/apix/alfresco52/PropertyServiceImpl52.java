...
@Primary
public class PropertyServiceImpl52 extends PropertyServiceBase {

    @Autowired
    public PropertyServiceImpl52(DictionaryService dictionaryService, ApixToAlfrescoConversion c) {
