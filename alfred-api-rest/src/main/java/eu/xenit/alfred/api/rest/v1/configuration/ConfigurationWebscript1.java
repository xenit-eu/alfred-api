package eu.xenit.alfred.api.rest.v1.configuration;
...
@RestController
public class ConfigurationWebscript1 extends AlfredApiV1Webscript {
    ...
    public ConfigurationWebscript1(
            @Qualifier("eu.xenit.alfred.api.configuration.ConfigurationService") ConfigurationService configurationService) {
