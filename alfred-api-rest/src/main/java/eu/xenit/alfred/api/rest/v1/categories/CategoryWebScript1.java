...
@RestController
public class CategoryWebScript1 extends AlfredApiV1Webscript {
    ...
    public ResponseEntity<Categories> getCategoriesForAspect(@PathVariable final String qname) {
        QName alfredApiQName = new QName(qname);
        List<Category> categories = categoryService.getCategoryTree(alfredApiQName);
