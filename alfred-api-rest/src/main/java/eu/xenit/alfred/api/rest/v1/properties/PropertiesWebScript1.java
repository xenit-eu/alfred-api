...
public class PropertiesWebScript1 extends AlfredApiV1Webscript {
    ...
    public ResponseEntity<?> getPropertyDefinition(@PathVariable final QName qname,
        ...
        QName alfredApiQName = qnameWithSlash != null ? qnameWithSlash : qname;
        PropertyDefinition propDef = propertyService.GetPropertyDefinition(alfredApiQName);
        if (propDef == null) {
