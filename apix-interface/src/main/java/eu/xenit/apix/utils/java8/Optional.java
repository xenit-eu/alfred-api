...
public final class Optional<T> {
     ...
     * processed, and then opens that file, returning an {@code Optional<FileInputStream>}:
     *
     * <pre>{@code
     ...
     * }</pre>
     *
     * Here, {@code findFirst} returns an {@code Optional<String>}, and then {@code map} returns an {@code
     * Optional<FileInputStream>} for the desired file if one exists.
     *
