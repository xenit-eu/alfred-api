...
/**
 * POJO for JSON serialization for responding to a /workflows/definitions call
 * It really just needs to wrap a JSON array in a JSON object with the key "data"
 */
